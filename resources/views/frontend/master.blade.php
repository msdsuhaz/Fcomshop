			...
			<div class="header-cart-content flex-w js-pscroll">
						...
						<li class="header-cart-item flex-w flex-t m-b-12">
							...
							<div class="header-cart-item-txt p-t-8">
								...
								<span class="header-cart-item-info">
									{{$contants->qty}}X{{$contants->price}}TK
								</span>
							</div>
						</li>
				...
				<div class="w-full">
					...
					<div class="header-cart-buttons flex-w w-full">
						<a href="{{route('view.Card')}}" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-r-8 m-b-10">
							View Cart
						</a>
	...
	<script src="{{asset('/')}}/frontend/js/main.js"></script>
	 ...
	 @if(session()->has('success'))
		  <script type="text/javascript">
		     $(function(){
				 $.notify("{{session()->get('sucess')}}",{globalPosition:'top right'className:'success'});
			 });
